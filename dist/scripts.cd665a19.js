...
//3. initalize
//Create new parallex
var parallex = new _giftbag.Parallex();
console.log(_giftbag.Parallex); //setup

var parallexElements = document.querySelectorAll('.parallax-element');
parallex.setup({
  selector: parallexElements
});
parallex.init;
var scroll = new scroll();
var scrollElements = document.querySelectorAll('.scroll-elements');
scroll.setup({
